...
const FormRegistration = () => {
    const validationSchema = yup.object().shape(
        {
            secondName: yup.string().typeError('Имя должно быть строкой')
                .required('Пожалуйста, укажите фамилию'),

            name: yup.string().typeError('Фамилия должна быть строкой')
                .required('Пожалуйста, укажите имя'),

            patronymic: yup.string().typeError('Отчество должно быть строкой')
                .required('Пожалуйста, укажите отчество'),

            numCard: yup.string().typeError('Номер карты должен быть в формате XX/XXXXXX')
                .required('Пожалуйста, укажите номер амбулаторной карты'),

            telephone: yup.number().typeError('Телефон должен состоять из цифр')
            ...
            password: yup.string().typeError('Пароль должнен быть строкой')
